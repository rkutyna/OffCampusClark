...
# These hosts are required for the application to run correctly in Docker
ALLOWED_HOSTS = [
    "django",
    "nginx",
]

# Add additional hosts from a comma-separated string in the .env file
# For example: ALLOWED_HOSTS_FROM_ENV=127.0.0.1,localhost,mydomain.com
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.abspath(os.sep), "gen/images")
